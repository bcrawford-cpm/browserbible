 ...
 */
export const OT_BOOKS = ["Gen","Exod","Lev","Num","Deut","Josh","Judg","Ruth","1Sam","2Sam","1Kgs","2Kgs","1Chr","2Chr","Ezra","Neh","Esth","Job","Ps","Prov","Eccl","Song","Isa","Jer","Lam","Ezek","Dan","Hos","Joel","Amos","Obad","Jonah","Mic","Nah","Hab","Zeph","Hag","Zech","Mal"];

/**
 * @description Default order of New Testament books
 */
export const NT_BOOKS = ["Matt","Mark","Luke","John","Acts","Rom","1Cor","2Cor","Gal","Eph","Phil","Col","1Thess","2Thess","1Tim","2Tim","Titus","Phlm","Heb","Jas","1Pet","2Pet","1John","2John","3John","Jude","Rev"];

/**
 * @description Default order of Apocryphal books
 */
export const AP_BOOKS = ["Tob","Jdt","AddEsth","Wis","Sir","Bar","EpJer","PrAzar","Sus","Bel","1Macc","2Macc","3Macc","4Macc","1Esd","2Esd","Ps151"];
...
export function addNames(lang, bookList, namesData) {
	for (var i in bookList) {
		...
		if (typeof names === 'string')
			BOOK_DATA[ osisKey ].names[lang] = [names];
		else
			BOOK_DATA[ osisKey ].names[lang] = names;
	}
}
